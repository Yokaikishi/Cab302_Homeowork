...
public class Guard extends LocatableObstacle {
    ...
    // Uses the method from the LocatableObstacle class
    ...
    // Uses the method from the ObstacleType class
    // Identifies what type of object is in the space to correctly identify it on the map
    @Override
